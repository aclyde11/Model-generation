...
if __name__ == '__main__':
    ...
    while oechem.OEReadMolecule(ifs, mol):
        ...
        try:
            ...
            scores.append(0.0)
            print("ValueError -- substituted 0.0")
        #            break
    ...
    for i in tqdm(sort_order,
                  desc=('writing out {}' if not args.u else 'writing unique molname out {}').format(args.o)):
        if (args.n == -1) or (i <= args.n):
