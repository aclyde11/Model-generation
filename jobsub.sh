...
#COBALT --attrs ssds=required:ssd_size=64
...
aprun -n 24576 -N 256 -cc depth -d 1 -j 4 python ../Model-generation/theta_dock.py -i /projects/CVD_Research/aclyde/Workflow0COVID/smiles/BL2.csv  -o out.sdf -v -n 24576 -r /projects/CVD_Research/aclyde/Workflow0COVID/receptors/receptorsVA/ADRP_ADPR_pocket1_rec_6W02_A__DU__APR_A-201.oeb.gz -l /local/scratch/
